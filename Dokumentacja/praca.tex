...
\titlePL{System zarządzania biblioteką – projekt i implementacja w C\#}
\titleEN{Thesis in \LaTeX}

\shorttitlePL{System zarządzania biblioteką} % skrócona wersja tytułu jeśli jest bardzo długi
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/oswiadczenie.jpg}
\end{figure}
